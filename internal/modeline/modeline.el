...
;; ==================================================
;; modeline.el
;; Custom Modeline - a custom-built modeline for my
;; Emacs configuration.
;;
...
;;
(defvar knavemacs/modeline-colors--text (face-foreground 'default))
(defvar knavemacs/modeline-colors--indicator-bg "#777777")
(defvar knavemacs/modeline-colors--indicator-fg "#FFFFFF")
