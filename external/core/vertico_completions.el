;; ==================================================
;; vertico_completions.el
;; Completions Stack using Vertico - redefine how
;; mini-buffer completions work across the board
;;
...
(use-package consult
  ...
  :bind (;; C-c bindings in `mode-specific-map'
         ...
         ("C-x C-b" . ibuffer)                     ;; buffer switch becomes ibuffer
