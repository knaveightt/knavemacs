;; ==================================================
;; multistate.el
;; Custom Modal Editing - borrowing from vim mostly,
;; this file defines a custom modal editing solution
...
START and END define the region in the source buffer."
  ...
  (define-key multistate-normal-state-map (kbd "g r") #'consult-ripgrep)
  ...
  ;; custom t keymap - replace this with tabs stuff
  ...
  (:map multistate-normal-state-map
	...
	("C-b" . ibuffer)
        ...
        ; t is a prefix key
        ; T coudl be a prefix key for tabs too
        ("u" . undo)
        ("U" . vundo)
