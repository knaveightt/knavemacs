...
#+BEGIN_SRC emacs-lisp
  ...
  (defun meow-setup ()
    ...
    (meow-normal-define-key
     ...
     '("B" . meow-back-symbol)
     '("c" . meow-change)
     '("C" . my/scroll-down-half-page)
     '("d" . meow-delete)
     '("D" . meow-backward-delete)
     '("e" . meow-next-word)
     '("E" . meow-next-symbol)
     '("f" . meow-find)
     '("F" . my/scroll-up-half-page)
     ...
     '("q" . meow-quit)
     '("r" . meow-replace)
     '("R" . move-to-window-line-top-bottom) ; for convenience (M-r)
     '("s" . meow-kill)
...
Here are some custom functions I've gathered on the internet that also help my workflow.
#+BEGIN_SRC emacs-lisp
