...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org
    ...
    (setq org-stuck-projects '("+TODO=\"ACTION\"" ("TODO")))
          ...
          '(
            ("d" "Todo Dashboard"
             (
              ...
              (todo "ACTION" ((org-agenda-overriding-header "In-Flight Actions")))
              ))
            ))
...
*** Shell Integration
5-line function I found on the internet for launching PowerShell on windows in a buffer
...
*** Breadcrumbs
Shows breadcrumb information in the buffer when using eglot / project / imenu.
...
*** Kind Icons in Corfu Completion Buffers
SVG Icon support!
