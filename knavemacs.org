...
#+BEGIN_SRC emacs-lisp
  ...
  ;; DEP: requires "JetBrainsMono Nerd Font" installed.
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org
    ...
    (setq org-agenda-files (list "~/.org" "~/.org/active" "~/.org/info"))
    ...
    (setq org-capture-templates
          '(
            ...
            ("f" "Fleeting Note" entry (file+olp "~/.org/fleeting.org" "Fleeting Notes")
             "* NOTE %?\n %i" :empty-lines 1)
            ))
    )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun knavemacs/org-roam-find-by-tag ()
    ...
    (org-roam-node-find
     nil
     nil
     (knavemacs/org-roam-filter-by-tag (knavemacs/org-roam-get-tag-selection))
     ))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package general
    ...
    (knavemacs/leader-keys
     ...
     "n"  '(:ignore t :which-key "Note Taking")
     "nf" '(org-roam-node-find :which-key "Create/View Note")
     "nb" '(org-roam-buffer-toggle :which-key "Show Backlinks Buffer")
     "nl" '(org-roam-node-insert :which-key "Create & Link New Note")
     "nL" '(knavemacs/org-roam-node-find-literature-only :which-key "View Literature Notes")
     "nT" '(knavemacs/org-roam-find-by-tag :which-key "View Notes by Selected Tag")
